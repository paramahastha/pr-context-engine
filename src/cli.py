...
def review(
    ...
    comment_text = _format_briefing(briefing, provider_attribution=provider.attribution())
...
def _format_briefing(briefing: Briefing, provider_attribution: str | None = None) -> str:
    ...
    parts: list[str] = [
        ...
        briefing.questions,
        "\n\n---\n",
        f"\n<sub>Generated by [PR Context Engine](https://github.com/anthropics/pr-context-engine){via}. "
